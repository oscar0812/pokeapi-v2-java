...
public class EvolutionDetail {
	...
	private evolution.EvolutionTrigger trigger;

	// The id of the gender of the evolving Pokémon species must be in order to evolve into this Pokémon species
	private int gender;

	// The item the evolving Pokémon species must be holding during the evolution trigger event to evolve into this Pokémon species
	private items.Item held_item;

	// The move that must be known by the evolving Pokémon species during the evolution trigger event in order to evolve into this Pokémon species
	private moves.Move known_move;

	// The evolving Pokémon species must know a move with this type during the evolution trigger event in order to evolve into this Pokémon species
	private pokemon.Type known_move_type;
	...
	private pokemon.PokemonSpecies party_species;
	...
	private pokemon.Type party_type;
	...
	private pokemon.PokemonSpecies trade_species;
	...
	public EvolutionDetail setItem(items.Item item) {
		this.item = item;
		return this;
	}

	public evolution.EvolutionTrigger getTrigger() {
		return trigger;
	}

	public EvolutionDetail setTrigger(evolution.EvolutionTrigger trigger) {
	...
	public items.Item getHeldItem() {
		return held_item;
	}

	public EvolutionDetail setHeldItem(items.Item held_item) {
		this.held_item = held_item;
		return this;
	}

	public moves.Move getKnownMove() {
		return known_move;
	}

	public EvolutionDetail setKnownMove(moves.Move known_move) {
		this.known_move = known_move;
		return this;
	}

	public pokemon.Type getKnownMoveType() {
		return known_move_type;
	}

	public EvolutionDetail setKnownMoveType(pokemon.Type known_move_type) {
	...
	public EvolutionDetail setLocation(locations.Location location) {
	...
	public pokemon.PokemonSpecies getPartySpecies() {
		return party_species;
	}

	public EvolutionDetail setPartySpecies(pokemon.PokemonSpecies party_species) {
		this.party_species = party_species;
		return this;
	}

	public pokemon.Type getPartyType() {
		return party_type;
	}

	public EvolutionDetail setPartyType(pokemon.Type party_type) {
	...
	public pokemon.PokemonSpecies getTradeSpecies() {
		return trade_species;
	}

	public EvolutionDetail setTradeSpecies(pokemon.PokemonSpecies trade_species) {
