...
public class Pokedex extends common.NamedAPIResource {
	...
	private java.util.ArrayList<games.PokemonEntry> pokemon_entries;
	...
	public static Pokedex getByName(String name) {
		String url = "https://pokeapi.co/api/v2/pokedex/" + name;
		String json = tools.Internet.get(url);
		Pokedex obj = new com.google.gson.Gson().fromJson(json, Pokedex.class);
		return obj;
	}
	...
	public Pokedex setDescriptions(java.util.ArrayList<common.Description> descriptions) {
	...
	public Pokedex setNames(java.util.ArrayList<common.Name> names) {
		this.names = names;
		return this;
	}

	public java.util.ArrayList<games.PokemonEntry> getPokemonEntries() {
		return pokemon_entries;
	}

	public Pokedex setPokemonEntries(java.util.ArrayList<games.PokemonEntry> pokemon_entries) {
	...
	public Pokedex setRegion(locations.Region region) {
		this.region = region;
		return this;
	}
	...
	public Pokedex setVersionGroups(java.util.ArrayList<games.VersionGroup> version_groups) {
