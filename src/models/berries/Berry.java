...
public class Berry extends models.common.NamedAPIResource {
	...
	private models.berries.BerryFirmness firmness;
	...
	private models.pokemon.Type natural_gift_type;
	...
	public models.berries.BerryFirmness getFirmness() {
		return firmness;
	}

	public Berry setFirmness(models.berries.BerryFirmness firmness) {
		this.firmness = firmness;
		return this;
	}

	public java.util.ArrayList<models.berries.BerryFlavorMap> getFlavors() {
		return flavors;
	}

	public Berry setFlavors(java.util.ArrayList<models.berries.BerryFlavorMap> flavors) {
	...
	public Berry setItem(models.items.Item item) {
		this.item = item;
		return this;
	}

	public models.pokemon.Type getNaturalGiftType() {
		return natural_gift_type;
	}

	public Berry setNaturalGiftType(models.pokemon.Type natural_gift_type) {
