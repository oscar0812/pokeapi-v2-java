...
public class Item extends common.NamedAPIResource {
	...
	private items.ItemFlingEffect fling_effect;

	// A list of attributes this item has
	private java.util.ArrayList<items.ItemAttribute> attributes;

	// The category of items this item falls into
	private items.ItemCategory category;

	// The effect of this ability listed in different languages
	private java.util.ArrayList<common.VerboseEffect> effect_entries;

	// The flavor text of this ability listed in different languages
	private java.util.ArrayList<common.VersionGroupFlavorText> flavor_text_entries;
	...
	private items.ItemSprites sprites;

	// A list of Pokémon that might be found in the wild holding this item
	private java.util.ArrayList<items.ItemHolderPokemon> held_by_pokemon;

	// An evolution chain this item requires to produce a bay during mating
	private evolution.EvolutionChain baby_trigger_for;
	...
	public items.ItemFlingEffect getFlingEffect() {
		return fling_effect;
	}

	public Item setFlingEffect(items.ItemFlingEffect fling_effect) {
		this.fling_effect = fling_effect;
		return this;
	}

	public java.util.ArrayList<items.ItemAttribute> getAttributes() {
		return attributes;
	}

	public Item setAttributes(java.util.ArrayList<items.ItemAttribute> attributes) {
		this.attributes = attributes;
		return this;
	}

	public items.ItemCategory getCategory() {
		return category;
	}

	public Item setCategory(items.ItemCategory category) {
	...
	public Item setEffectEntries(java.util.ArrayList<common.VerboseEffect> effect_entries) {
		this.effect_entries = effect_entries;
		return this;
	}

	public java.util.ArrayList<common.VersionGroupFlavorText> getFlavorTextEntries() {
		return flavor_text_entries;
	}

	public Item setFlavorTextEntries(java.util.ArrayList<common.VersionGroupFlavorText> flavor_text_entries) {
	...
	public Item setGameIndices(java.util.ArrayList<common.GenerationGameIndex> game_indices) {
	...
	public Item setNames(java.util.ArrayList<common.Name> names) {
		this.names = names;
		return this;
	}

	public items.ItemSprites getSprites() {
		return sprites;
	}

	public Item setSprites(items.ItemSprites sprites) {
		this.sprites = sprites;
		return this;
	}

	public java.util.ArrayList<items.ItemHolderPokemon> getHeldByPokemon() {
		return held_by_pokemon;
	}

	public Item setHeldByPokemon(java.util.ArrayList<items.ItemHolderPokemon> held_by_pokemon) {
		this.held_by_pokemon = held_by_pokemon;
		return this;
	}

	public evolution.EvolutionChain getBabyTriggerFor() {
		return baby_trigger_for;
	}

	public Item setBabyTriggerFor(evolution.EvolutionChain baby_trigger_for) {
	...
	public Item setMachines(java.util.ArrayList<common.MachineVersionDetail> machines) {
