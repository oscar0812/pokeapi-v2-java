...
public class MoveBattleStylePreference {
	...
	private moves.MoveBattleStyle move_battle_style;
	...
	public moves.MoveBattleStyle getMoveBattleStyle() {
		return move_battle_style;
	}

	public MoveBattleStylePreference setMoveBattleStyle(moves.MoveBattleStyle move_battle_style) {
