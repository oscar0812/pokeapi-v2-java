...
public class Pokemon extends common.NamedAPIResource {
	...
	private java.util.ArrayList<pokemon.PokemonAbility> abilities;

	// A list of forms this Pokémon can take on
	private java.util.ArrayList<pokemon.PokemonForm> forms;

	// A list of game indices relevent to Pokémon item by generation
	private java.util.ArrayList<common.VersionGameIndex> game_indices;

	// A list of items this Pokémon may be holding when encountered
	private java.util.ArrayList<pokemon.PokemonHeldItem> held_items;

	// A link to a list of location areas as well as encounter details pertaining to specific versions
	private String location_area_encounters;

	// A list of moves along with learn methods and level details pertaining to specific version groups
	private java.util.ArrayList<pokemon.PokemonMove> moves;

	// A set of sprites used to depict this Pokémon in the game
	private pokemon.PokemonSprites sprites;

	// The species this Pokémon belongs to
	private pokemon.PokemonSpecies species;

	// A list of base stat values for this Pokémon
	private java.util.ArrayList<pokemon.PokemonStat> stats;

	// A list of details showing types this Pokémon has
	private java.util.ArrayList<pokemon.PokemonType> types;
	...
	public java.util.ArrayList<pokemon.PokemonAbility> getAbilities() {
		return abilities;
	}

	public Pokemon setAbilities(java.util.ArrayList<pokemon.PokemonAbility> abilities) {
		this.abilities = abilities;
		return this;
	}

	public java.util.ArrayList<pokemon.PokemonForm> getForms() {
		return forms;
	}

	public Pokemon setForms(java.util.ArrayList<pokemon.PokemonForm> forms) {
		this.forms = forms;
		return this;
	}

	public java.util.ArrayList<common.VersionGameIndex> getGameIndices() {
		return game_indices;
	}

	public Pokemon setGameIndices(java.util.ArrayList<common.VersionGameIndex> game_indices) {
		this.game_indices = game_indices;
		return this;
	}

	public java.util.ArrayList<pokemon.PokemonHeldItem> getHeldItems() {
		return held_items;
	}

	public Pokemon setHeldItems(java.util.ArrayList<pokemon.PokemonHeldItem> held_items) {
	...
	public java.util.ArrayList<pokemon.PokemonMove> getMoves() {
		return moves;
	}

	public Pokemon setMoves(java.util.ArrayList<pokemon.PokemonMove> moves) {
		this.moves = moves;
		return this;
	}

	public pokemon.PokemonSprites getSprites() {
		return sprites;
	}

	public Pokemon setSprites(pokemon.PokemonSprites sprites) {
	...
	public Pokemon setSpecies(pokemon.PokemonSpecies species) {
		this.species = species;
		return this;
	}

	public java.util.ArrayList<pokemon.PokemonStat> getStats() {
		return stats;
	}

	public Pokemon setStats(java.util.ArrayList<pokemon.PokemonStat> stats) {
		this.stats = stats;
		return this;
	}

	public java.util.ArrayList<pokemon.PokemonType> getTypes() {
		return types;
	}

	public Pokemon setTypes(java.util.ArrayList<pokemon.PokemonType> types) {
		this.types = types;
		return this;
	}
