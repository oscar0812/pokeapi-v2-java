...
public class MoveMetaData {
	...
	private moves.MoveAilment ailment;

	// The category of move this move falls under, e.g. damage or ailment
	private moves.Move category;
	...
	public moves.MoveAilment getAilment() {
		return ailment;
	}

	public MoveMetaData setAilment(moves.MoveAilment ailment) {
		this.ailment = ailment;
		return this;
	}

	public moves.Move getCategory() {
		return category;
	}

	public MoveMetaData setCategory(moves.Move category) {
